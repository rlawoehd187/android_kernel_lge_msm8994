...
/*                                   */
static struct msm_sensor_power_setting imx135_power_down_setting[] = {
	{
		.seq_type = SENSOR_I2C_MUX,
		.seq_val = 0,
		.config_val = 0,
...
/*                                   */
	.power_setting_array.power_down_setting= imx135_power_down_setting,
	.power_setting_array.size_down = ARRAY_SIZE(imx135_power_down_setting),
/*                                   */
